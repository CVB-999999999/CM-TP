...
class EditarPerfil : AppCompatActivity() {
    ...
    private fun validarDados() {
        ...
        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
            ...
            //sem contacto
            binding.telemovelEt.error = R.string.phoneInvalidFEmpty.toString()
        }else if (telemovel.length<6){
            //sem comprimento suficiente
            binding.telemovelEt.error = R.string.phoneInvalidF.toString()
        }else if (TextUtils.isEmpty(nome)){
            //sem nome
            binding.nomeEt.error = R.string.nameInvalidF.toString()
        }else{
    ...
    private fun atualizarImagem() {
        ...
        reference.putFile(imagegeUri!!)
            ...
            .addOnFailureListener{
                ...
                Toast.makeText(this, R.string.erroImage, Toast.LENGTH_SHORT).show()
            }

    }

    private fun atualizarPerfil(imagemUrl: String) {
        progressDialog.setMessage(R.string.updateProfile.toString())
        ...
        reference.child(firebaseAuth.uid!!)
            ...
            .addOnSuccessListener {
                ...
                //Envia um toast de erro
                Toast.makeText(this, R.string.profileUpdate, Toast.LENGTH_SHORT).show()
            }
            .addOnFailureListener {
                progressDialog.dismiss()

                //Envia um toast de erro
                Toast.makeText(this, R.string.erroProfileUp, Toast.LENGTH_SHORT).show()
            }
    ...
    private fun showimageMenu(){
        ...
        popupMenu.menu.add(Menu.NONE, 1, 1, R.string.gallery)
        popupMenu.show()
    ...
    private val cameraActivity = registerForActivityResult(
        ...
        ActivityResultCallback<ActivityResult>{result ->
            ...
            if (result.resultCode == Activity.RESULT_OK){
                ...
                //erro cancela
                Toast.makeText(this, R.string.erroImpCon, Toast.LENGTH_SHORT).show()
            }
        }
    )
